...
import Clases.MantenimientoSucursales;
...
MantenimientoSucursales man = new MantenimientoSucursales(); 
int fila;
int codigo; 
    /**
    ...
    public Sucursales() {
        ...
        llenarciudades();
        man.cargarTablaSucursales(jdetalle, 0, 0, "", "", "", "", "mostrar");
    }
    ...
    private void jdetalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jdetalleMouseClicked
        ...
        String nombre = jdetalle.getValueAt(fila, 0).toString(); 
        
        
        Connection con = cone.obtenerconexion();
        
       
        CallableStatement cmd = con.prepareCall("{CALL mostrarSucursalEspecifica(?)}"); 
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        man.mantenimientoSucursales(codigo,0, "1","1","1","1","eliminar");
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        if (Validaciones.esCampoVacio(TxtNombre, "Nombre de Sucursal") || 
...
if (!Validaciones.esSoloLetras(TxtNombre, "Nombre del Cliente") || 
 ...
 limpiarCampos();
    ...
    private void TxtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtBuscarKeyPressed
        ...
        "FROM Sucursales s " +
        "INNER JOIN Ciudades ci ON s.ID_CIUDAD = ci.ID " +
        "WHERE s.NOMBRE LIKE '%" + TxtBuscar.getText() + "%' ";
